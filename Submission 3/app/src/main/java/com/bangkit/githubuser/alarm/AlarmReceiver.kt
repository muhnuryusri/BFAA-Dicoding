package com.bangkit.githubuser.alarm
...
import com.bangkit.githubuser.MainActivity
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    fun setDailyReminder(context: Context, type: String, message: String) {
        ...
        StyleableToast.makeText(context, "Daily Reminder is ON", R.style.MyToastTrue).show()
    }
    ...
    fun cancelAlarm(context: Context) {
        ...
        StyleableToast.makeText(context, "Daily Reminder is OFF", R.style.MyToastTrue).show()
    }
